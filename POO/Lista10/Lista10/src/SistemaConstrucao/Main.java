...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Profissional prof1 = new Profissional(101, "111.111.111-11", "Ana Beatriz Silva");
        Profissional prof2 = new Profissional(102, "222.222.222-22", "Carlos Eduardo Lima");
        Profissional prof3 = new Profissional(103, "333.333.333-33", "Mariana Costa");
        ...
        Profissional prof4_duplicadoID = new Profissional(101, "444.444.444-44", "Pedro Alves");
        Profissional prof5_duplicadoCPF = new Profissional(105, "111.111.111-11", "Lucas Mendes");
        sistema.cadastrarProfissional(prof4_duplicadoID); // Deve falhar
        ...
        // Projeto Público 1
        Projeto proj1_publico = new ProjetoPublico(
                1, LocalDate.of(2025, Month.JANUARY, 10),
        ...
        Projeto proj2_privado = new EmpreendimentoPrivado(
                2, LocalDate.of(2025, Month.FEBRUARY, 20),
        ...
        // Projeto Público 2
        Projeto proj3_publico = new ProjetoPublico(
                3, LocalDate.of(2025, Month.MAY, 5),
